...
export default function SudokuBoard({
  ...
  return (
    <div className="grid grid-cols-9 gap-[1px] bg-indigo-300 p-[1px] md:p-[2px] rounded-md shadow-lg">
        ...
        row.map((cell, colIndex) => {
          ...
          return (
            <div
              ...
              className={cn(
                "aspect-square flex items-center justify-center text-sm md:text-lg font-medium bg-white",
                ...
                isOriginalCell(rowIndex, colIndex) && "bg-indigo-50 font-bold text-indigo-800",
